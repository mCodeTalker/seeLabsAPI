...
import 'package:seelabs/addnilai.dart';

class NilaiPage extends StatefulWidget {
  NilaiPage({Key key, this.title, this.kid}) : super(key: key);
  final String title;
  final int kid;
  ...
  // always marked "final".
  @override
  _NilaiPageState createState() => _NilaiPageState(title, kid);
}
...
class _NilaiPageState extends State<NilaiPage> {
  ...
  _NilaiPageState(String title, int kid) {
    this.title = title;
    this.kid = kid;
  }
